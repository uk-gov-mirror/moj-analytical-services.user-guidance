...
**NOTE:** To use pip with a virtual environment you should delete your `.bash_aliases` file from your home directory, if you have it: `rm .bash_aliases`.
Otherwise you'll find it always installs packages to `~/.local` instead of the activated virtual environment. Only users who joined the Analytical Platform before 31st July 2020 has the problematic alias contained in this file.
